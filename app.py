...
with col1:
    ...
    sentiment_toggle = st.toggle("Sentiment Analysis Toggle", False)
...
with col2:
    ...
    technical_toggle = st.toggle("Technical Indicators Toggle", False)
...
with col3:
    ...
    fundamental_toggle = st.toggle("Fundamental Data Toggle", False)
