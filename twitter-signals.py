...
def fetch_twitter_signals():
    try:
        ...
        columns = ["date", "comp_symbol", "analyzed_tweets", "sentiment_score", "sentiment", "entry_price"]
...
# Streamlit UI - Twitter Signals Page
st.markdown("<h1 style='text-align: center;'>Twitter Signals</h1>", unsafe_allow_html=True)
st.write("View the latest Twitter sentiment signals for each stock.")

# Fetch and display the Twitter signals
